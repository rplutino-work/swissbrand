...
const Contacto: StorefrontFunctionComponent = () => {
  if (!canUseDOM) return <></>
  const script = `
  <div class="typeform-widget" data-url="https://form.typeform.com/to/QzcjWAJW?typeform-medium=embed-snippet" style="width: 100%; height: 600px;"></div>
  `
